...
VideoGenre.create!(video_id: russian_doll.id, genre_id: trending.id)
...
VideoGenre.create!(video_id: politician.id, genre_id: trending.id)
VideoGenre.create!(video_id: space_force.id, genre_id: trending.id)
