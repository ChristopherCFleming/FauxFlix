...
becoming.video_url.attach(io: becomingv, filename: 'becoming_final.mp4')
...
hill_house.video_url.attach(io: hill_housev, filename: 'hill_house_final.mp4')
...
house_of_cards.video_url.attach(io: house_of_cards_v, filename: 'house_of_cards_final.mp4')
...
maniac.video_url.attach(io: maniac_v, filename: 'maniac_final.mp4')
...
queens_gambit.video_url.attach(io: queens_gambit_v, filename: 'queens_gambit_final.mp4')
...
ratched.video_url.attach(io: ratched_v, filename: 'ratched_final.mp4')
...
russian_doll.video_url.attach(io: russian_doll_v, filename: 'russian_doll_final.mp4')
...
sabrina.video_url.attach(io: sabrinav, filename: 'sabrina_final.mp4')
...
sense8.video_url.attach(io: sense8v, filename: 'sense8_final.mp4')
...
politician.video_url.attach(io: the_politician_v, filename: 'the_politician_final.mp4')
...
space_force.video_url.attach(io: space_force_v, filename: 'space_force_final.mp4')
...
stranger_things.video_url.attach(io: stranger_things_v, filename: 'stranger_things_final.mp4')
...
tidying_up.video_url.attach(io: tidying_up_v, filename: 'tidying_up_with_marie_kondo_final.mp4')
...
unbreakable.video_url.attach(io: unbreakable_v, filename: 'unbreakable_kimmy_schmidt_final.mp4')
...
witcher.video_url.attach(io: witcher_v, filename: 'witcher_final.mp4')
